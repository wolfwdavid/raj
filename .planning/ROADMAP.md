...
- [x] 05-02-PLAN.md — cannaworldnews article:published_time + og:type=article + finalized informational-only footer disclaimer + CI Compliance Gate in deploy.yml (site-wide no-fake-success + per-page SEO meta + disclaimer + FTC label + no-aggregateRating) — NEWS-04, NEWS-05
