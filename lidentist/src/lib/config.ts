...
// custom-domain cutover set VITE_SITE_URL='https://lidentist.reviews' — one knob, no code change.
// No trailing slash (paths passed to <Seo> carry the leading + trailing slash).
export const SITE_URL: string = import.meta.env.VITE_SITE_URL ?? 'https://wolfwdavid.github.io/raj/lidentist';
